...
impl RemoteEndPoint
{
	...
	#[inline(always)]
	pub fn active_message_sending(&self, active_message_identifier: ActiveMessageIdentifier) -> ActiveMessageSendingRemoteEndPoint
	{
...
//TODO: Reclaim of zero_copy_io_vectors when complete for remote memory and active message end points.
