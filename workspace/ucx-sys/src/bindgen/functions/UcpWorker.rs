...
extern "C"
{
	...
	pub fn ucp_worker_flush_nb(worker: ucp_worker_h, flags: c_uint, cb: ucp_send_callback_t) -> ucs_status_ptr_t;
	...
	pub fn ucp_worker_progress(worker: ucp_worker_h) -> c_uint;
