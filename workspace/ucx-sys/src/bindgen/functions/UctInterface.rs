...
extern "C"
{
	#[link_name = "\u{1}_uct_iface_close"] pub fn uct_iface_close(iface: uct_iface_h);
	...
	#[link_name = "\u{1}_uct_iface_open"] pub fn uct_iface_open(md: uct_md_h, worker: uct_worker_h, params: *const uct_iface_params_t, config: *const uct_iface_config_t, iface_p: *mut uct_iface_h) -> ucs_status_t;
	#[link_name = "\u{1}_uct_iface_query"] pub fn uct_iface_query(iface: uct_iface_h, iface_attr: *mut uct_iface_attr_t) -> ucs_status_t;
