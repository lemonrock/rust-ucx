...
pub struct uct_iface_ops
{
	...
	pub ep_am_bcopy: Option<unsafe extern "C" fn(ep: uct_ep_h, id: u8, pack_cb: uct_pack_callback_t, arg: *mut c_void, flags: c_uint) -> isize>,
	pub ep_am_zcopy: Option<unsafe extern "C" fn(ep: uct_ep_h, id: u8, header: *const c_void, header_length: c_uint, iov: *const uct_iov_t, iovcnt: usize, flags: c_uint, comp: *mut uct_completion_t) -> ucs_status_t>,
	...
	pub ep_tag_eager_bcopy: Option<unsafe extern "C" fn(ep: uct_ep_h, tag: uct_tag_t, imm: u64, pack_cb: uct_pack_callback_t, arg: *mut c_void, flags: c_uint) -> isize>,
	pub ep_tag_eager_zcopy: Option<unsafe extern "C" fn(ep: uct_ep_h, tag: uct_tag_t, imm: u64, iov: *const uct_iov_t, iovcnt: usize, flags: c_uint, comp: *mut uct_completion_t) -> ucs_status_t>,
	pub ep_tag_rndv_zcopy: Option<unsafe extern "C" fn(ep: uct_ep_h, tag: uct_tag_t, header: *const c_void, header_length: c_uint, iov: *const uct_iov_t, iovcnt: usize, flags: c_uint, comp: *mut uct_completion_t) -> ucs_status_ptr_t>,
	pub ep_tag_rndv_cancel: Option<unsafe extern "C" fn(ep: uct_ep_h, op: *mut c_void) -> ucs_status_t>,
	pub ep_tag_rndv_request: Option<unsafe extern "C" fn(ep: uct_ep_h, tag: uct_tag_t, header: *const c_void, header_length: c_uint, flags: c_uint) -> ucs_status_t>,
	...
	pub ep_create_sockaddr: Option<unsafe extern "C" fn(iface: uct_iface_h, sockaddr: *const ucs_sock_addr_t, priv_data: *const c_void, length: usize, ep_p: *mut uct_ep_h) -> ucs_status_t>,
	...
	pub iface_progress_enable: Option<unsafe extern "C" fn(iface: uct_iface_h, flags: c_uint)>,
	pub iface_progress_disable: Option<unsafe extern "C" fn(iface: uct_iface_h, flags: c_uint)>,
	pub iface_progress: Option<unsafe extern "C" fn(iface: uct_iface_h) -> c_uint>,
	pub iface_event_fd_get: Option<unsafe extern "C" fn(iface: uct_iface_h, fd_p: *mut c_int) -> ucs_status_t>,
	pub iface_event_arm: Option<unsafe extern "C" fn(iface: uct_iface_h, events: c_uint) -> ucs_status_t>,
